...
public class Bola extends JLabel {
	...
	public void setTipo(int tipo) {
		...
		xInicial = 30 * 4;
		yInicial = Bloco.NIVEL_MEDIO_BAIXO - getHeight();
	...
	public boolean verificaColisao(Moeda moeda) {
		...
		// Verifica se a distancia do centro da bola até o centro da moeda é menor que a soma dos seus raios
	...
	public boolean verificaColisao(Bloco bloco) {
