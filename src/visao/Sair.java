...
public class Sair extends JPanel {
	...
	public JLabel getFundoSair() {
		if (fundoSair == null) {
			...
			fundoSair.setLocation(getWidth()/2 - fundoSair.getWidth()/2, getHeight()/2 - fundoSair.getHeight()/2 + 90);
		}
		return fundoSair;
	}
	...
	public JTextPane getMensagemSair() {
		if (mensagemSair == null) {
			...
			String txt = "Are you sure you want to exist?";
	...
	public JLabel getBotaoSim() {
		if (botaoSim == null) {
			...
			botaoSim.setLocation(getWidth()/2 - botaoSim.getWidth() - 20, getFundoSair().getY() + getFundoSair().getHeight()/2 + 10);
		}
		return botaoSim;
	}
	...
	public JLabel getBotaoFechar() {
		if (botaoFechar == null) {
			...
			botaoFechar.setSize(Imagens.getImgBotaoFechar().getIconWidth(), Imagens.getImgBotaoFechar().getIconHeight());
