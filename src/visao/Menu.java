...
public class Menu extends JPanel {
	...
	public JLabel getBotaoAjuda() {
		if (botaoAjuda == null) {
			...
			int y = getBotaoJogar().getY() + getBotaoJogar().getHeight() + (getFundoMenu().getHeight()/3 - getBotaoJogar().getHeight())/2;
	...
	public JLabel getBotaoSair() {
		if (botaoSair == null) {
			...
			int y = getBotaoAjuda().getY() + getBotaoAjuda().getHeight() + (getFundoMenu().getHeight()/3 - getBotaoJogar().getHeight())/2;
