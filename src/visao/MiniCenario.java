...
public class MiniCenario extends JPanel {
	...
	public JLabel getIconeCadeado() {
		if (cadeado == null) {
			...
			cadeado.setLocation(getWidth()/2 - cadeado.getWidth()/2, getHeight()/2 - cadeado.getHeight()/2 + 10);
		}
		return cadeado;
	}
	...
	public JLabel getEstrelaCont() {
		if (estrelaCont == null) {
			...
			estrelaCont.setSize(Imagens.getImgEstrela().getIconWidth()*2 + 25, Imagens.getImgEstrela().getIconHeight());
