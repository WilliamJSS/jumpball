...
public class Fases extends JPanel {
	...
	public Fases() {
		...
		setCenarioSelecionado(Cenario.TIPO_CAMPO);
		atualizarSelecao(getCenarioSelecionado());
	}
	...
	public void atualizarSelecao(int codMiniCenario) {
		...
		int y = getMiniCenario(codMiniCenario).getY() + getMiniCenario(codMiniCenario).getHeight() - getBolaDeSelecao().getHeight() + 10;
